...
export interface FormContainerComponent extends ApplicationAction<FormContainerComponentState> {
    undo(): void
    redo(): void
}
...
export interface FormFieldComponent<S, E> extends ApplicationAction<FormFieldComponentState<S, E>> {
    validate(): void
}
...
export interface FormInputComponent extends ApplicationAction<FormInputComponentState> {
