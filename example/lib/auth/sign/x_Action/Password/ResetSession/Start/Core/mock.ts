...
import { StartPasswordResetSessionAction, StartPasswordResetSessionState } from "./action"

type Passer = MockPropsPasser<StartPasswordResetSessionMockProps>

export type StartPasswordResetSessionMockProps =
...
export function initMockStartPasswordResetSessionAction(
    passer: Passer
...
export class Action
    extends MockAction<StartPasswordResetSessionState>
    ...
    constructor(passer: Passer) {
        ...
        function mapProps(
            props: StartPasswordResetSessionMockProps
