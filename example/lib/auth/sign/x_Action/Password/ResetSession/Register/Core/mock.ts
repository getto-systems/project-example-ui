...
type Passer = MockPropsPasser<RegisterPasswordMockProps>

export type RegisterPasswordMockProps =
...
export function initMockRegisterPasswordAction(passer: Passer): RegisterPasswordAction {
    return new Action(passer)
}

class Action extends MockAction<RegisterPasswordState> implements RegisterPasswordAction {
    constructor(passer: Passer) {
        ...
        function mapProps(props: RegisterPasswordMockProps): RegisterPasswordState {
            switch (props.type) {
                case "initial":
