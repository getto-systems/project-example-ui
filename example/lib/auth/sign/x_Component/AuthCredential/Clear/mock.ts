...
export type ClearAuthCredentialMockPropsPasser = MockPropsPasser<ClearAuthCredentialMockProps>
...
class Component
    ...
    constructor(passer: ClearAuthCredentialMockPropsPasser) {
        ...
        function mapProps(props: ClearAuthCredentialMockProps): ClearAuthCredentialComponentState {
            switch (props.type) {
                case "failed":
