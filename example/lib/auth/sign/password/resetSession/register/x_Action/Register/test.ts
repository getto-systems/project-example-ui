...
import { initRegisterPasswordSimulate } from "../../infra/remote/register/simulate"

import { Clock } from "../../../../../../../z_getto/infra/clock/infra"
import { RegisterPasswordRemote, RegisterPasswordResult } from "../../infra"

import { RegisterPasswordAction } from "./action"

import { RegisterPasswordCoreState } from "./Core/action"
...
function initAsyncTester() {
    return initAsyncActionTester_legacy((state: RegisterPasswordCoreState) => {
        switch (state.type) {
            case "initial-reset":
                return false
