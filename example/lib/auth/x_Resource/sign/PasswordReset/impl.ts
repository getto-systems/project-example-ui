...
import { initPasswordResetRegisterAction } from "../../../sign/password/reset/register/impl"
...
export function initPasswordResetResource(
    ...
    return {
        reset: initResetComponent({
            ...foreground,
            register: initPasswordResetRegisterAction(locationInfo, background.initRegister),
        }),
